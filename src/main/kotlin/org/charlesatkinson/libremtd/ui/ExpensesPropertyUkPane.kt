    ...
    private fun buildEntriesTable(): VBox {
        val table = TableView<ExpensePropertyUkEntry>(entries).apply {
            ...
            columns.addAll(
                ...
                TableColumn<ExpensePropertyUkEntry, String>("Category").apply {
                    prefWidth = 240.0
                    setCellValueFactory {
                ...
                TableColumn<ExpensePropertyUkEntry, String>("Description").apply {
                    prefWidth = 180.0
                    setCellValueFactory { SimpleStringProperty(it.value.description) }
                },
                TableColumn<ExpensePropertyUkEntry, String>("Amount").apply {
                    prefWidth = 100.0
